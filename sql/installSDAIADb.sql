...
-- -----------------------------------------------------
-- Table `sdaia`.`users_has_groups`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdaia`.`users_has_groups` ;

CREATE TABLE IF NOT EXISTS `sdaia`.`users_has_groups` (
  `users_userid` INT NOT NULL,
  `groups_groupid` INT NOT NULL,
